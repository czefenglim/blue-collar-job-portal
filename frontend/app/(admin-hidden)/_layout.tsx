...
export default function HiddenLayout() {
  ...
  return (
    ...
    >
      <Stack.Screen
        name="login"
        options={{ title: t('adminHiddenLayout.login') }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        name="jobs/[id]"
        options={{ title: t('adminHiddenLayout.jobDetails') }}
      />
      <Stack.Screen
        name="appeals/index"
      ...
      <Stack.Screen
        name="appeals/[id]"
        options={{ title: t('adminHiddenLayout.appealDetails') }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        name="companies/page"
        options={{ title: t('adminHiddenLayout.companies') }}
      />
      <Stack.Screen
        name="companies/[id]"
