...
// // Store active connections: Map<conversationId, Set<userId>>
...
//           // Send message through service (handles permissions and notifications)
...
//             // Check if receiver is in conversation
//             const receiverInConversation = activeConversations
//               .get(conversationId)
//               ?.has(receiverId);

//             // If receiver not in conversation, send to their personal room
...
//               });
//             } else {
//               // Auto-mark as read since receiver is viewing
